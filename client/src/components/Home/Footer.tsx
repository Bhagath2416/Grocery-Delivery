...
import { footerData } from "../../assets/footer";
const Footer = () => {
    return (
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-white/70 mb-4">Bringing fresh,organic groceries straight from local farms to your doorstep.Nourish your home with Earths finest.</p>
