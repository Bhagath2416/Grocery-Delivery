...
<div className="flex flex-col md:flex-row items-center jusitfy-between gap-8 xl:px-10">
        {/* Left side content */}
    <div className="text-center md:text-left">
        <h2 className="font-serif text-3xl sm:text-4xl text-white mb-3">Get fresh groceries in minutes</h2>
        <p className="text-white/70 mb-6 max-w-md">Download the instacart app for exclusive deals, real-time 
      ...
      {/* Right side image */}
      <img src={deliverytruck} alt="Delivery Truck" className="max-w-60 sm:max-w-120 xl:pr-10"/>
</div>
