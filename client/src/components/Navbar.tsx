    ...
    return (
        <nav className="bg-white sticky top-0 z-50 border-b border-app-border">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 gap-4">
                {/* Logo ,import link from react router dom */}
                            ...
                            {userMenuOpen && (
                                <>
                                    <div className="fixed inset-0 z-40" onClick={() =>
                                        setUserMenuOpen(false)
                                        // closed our side menu that diplayed the menu items as dropdown
                                    } />
                                    <div className="absolute right-0 mt-2.5 w-56 bg-white rounded-xl shadow-lg border border-app-border py-2 z-50 animate-fade-in">
                                        ...
                                        <div onClick={() => setUserMenuOpen(false)}>
                                            ...
                                            {user?.isAdmin && (<Link to='/admin/products' className="dropdown-link"><ShieldIcon className="text-app-orange-dark" size={16} /><span className="text-app-orange-dark">Admin Panel</span> </Link>
                                            )}
                                            {user && (
