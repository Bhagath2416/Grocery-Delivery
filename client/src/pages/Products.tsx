  ...
  return (
    <div className="min-h-screen bg-app-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        {/* BreadCrumb => home icon and writing names */}
        ...
        {/* content for desktop screen for filters */}
        <div className="flex gap-8 xl:gap-10">
          ...
          <main className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex flex-col lg:items-center gap-3">
                ...
                <div className="relative">
                  {/* here the select is used to create a dropdown menu. */}
                  ...
                  >
                    ...
                    <option value="price_desc">Price: Hight → Low</option>
            ...
            {/* Product Grid or all products display */}
            {loading ? (
              <Loading />
            ) : products.length === 0 ? (
              // no products found
              ...
              // display products 10 or your wish
            ...
            {totalPages > 1 && (
              <div className="flex-center gap-2 mt-16">
                {Array.from({ length: totalPages }).map((_, i) => (
                  // here using an dynamic classes using $ symbol
                  <button key={i}
      ...
      {/* mobile filter modal it shows categories all when click on filters */}
      {mobileFilterOpen && (
        <>
