...
const Login = () => {
  ...
  return (
    ...
    // 100 vh flex horizontal box
    <div className="min-h-screen flex">


      {/* divide content in left and right */}


      {/* left side */}
      <div className="hidden lg:flex lg:w-1/2 bg-app-green relative items-center justify-center">
        <img src={heroSectionData} alt="" className="absolute inset-0 object-cover h-full bg-center opacity-20" />
